...
public class MealsUtil {
    ...
    public static List<MealWithExceed> getWithExceeded(Collection<Meal> meals) {
        return  getFilteredWithExceeded(meals, LocalTime.MIN, LocalTime.MAX, CALORIES_LIMIT);
    }
